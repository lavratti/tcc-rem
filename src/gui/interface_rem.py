...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        with open('sobre.html', 'r') as fp:
            texto_sobre = fp.read()
        self.tela_sobre_textBrowser.setHtml(texto_sobre)
        ...
        self.tela_resultado_textBrowser.setHtml(_translate("Form", ""))
        ...
        self.tela_historico_textBrowser.setHtml(_translate("Form", ""))
    ...
    def salvar_configuracoes(self):
        ...
        msg.setText("Ainda não implementado.")
        msg.setIcon(QMessageBox.Warning)
        x = msg.exec_()
